...
//        titleBar.setText(getString(R.string.app_name));
        ...
        try {
            ...
            DBUtil.getWritableInstance(this).getDatabase().execSQL("ALTER TABLE Cash ADD COLUMN CURRENCY_TYPE TEXT NOT NULL DEFAULT '" + getString(R.string.toman) + "'");
            DBUtil.getWritableInstance(this).getDatabase().execSQL("ALTER TABLE Cash ADD COLUMN WITH_DEPOSIT INTEGER NOT NULL DEFAULT 1");
            DBUtil.getWritableInstance(this).getDatabase().execSQL("ALTER TABLE Cash ADD COLUMN CHECK_CASH_REMAIN INTEGER NOT NULL DEFAULT 1");
            DBUtil.getWritableInstance(this).getDatabase().execSQL("ALTER TABLE Cash ADD COLUMN AFFECT_NEXT INTEGER NOT NULL DEFAULT 1");
            DBUtil.getWritableInstance(this).getDatabase().execSQL("ALTER TABLE Cash ADD COLUMN NOTIFY_DAY_OF_LOAN INTEGER NOT NULL DEFAULT 1");
            cashtEntity = new CashtEntity(this);
        }
