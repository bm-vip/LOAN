...
//        int color = Color.parseColor("#00C853");
        ...
        holder.editDebitCredit.setIconColor(Color.parseColor(color));

        holder.editDebitCredit.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            editDebitCredit = (TextViewPlus) view.findViewById(R.id.editEvent);
