...
public class LoanListAdapter extends RecyclerView.Adapter<LoanListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (entity.getSettled()) {
            ...
            holder.editLoan.setVisibility(View.GONE);
        } else {
    ...
    private void deleteItem(LoanEntity loanEntity, int position) {
        debitCreditEntityDao.queryBuilder().where(LoanId.eq(loanEntity.getId())).buildDelete().executeDeleteWithoutDetachingEntities();
        loanEntityDao.delete(loanEntity);
        loanEntities.remove(loanEntity);
